...
public class DoctorWindowViewModel {
	...
	/**************************************
	 * Property currentDoctorItem
	 ***************************************/
	private Doctor currentDoctorItem;
	
	public Doctor getCurrentDoctorItem() {
		return currentDoctorItem;
	}

	public void setCurrentDoctorItem(Doctor currentDoctorItem) {
		this.currentDoctorItem = currentDoctorItem;
	}
	...
	***************************************/
	...
	public void init(@ContextParam(ContextType.VIEW) Component view, 
		...
		if (this.actionType.equals("NEW")) {
			...
			currentDoctorItem.setContactInfo(contactInfoItem);
			addressList = new ArrayList<Address>();
			phonesList = new ArrayList<PhoneNumber>();
		}

		if (this.actionType.equals("EDIT")) {
			currentDoctorItem = currentItem;
	...
	public void save() {
		...
		currentDoctorItem.setContactInfo(contactInfoItem);
		DataSourceLoader.getInstance().mergeRecord(currentDoctorItem);
		...
		phItemToSend.setDoctor(currentDoctorItem);
